...
enum message
{
	...
	/* SIPL 2014-03-07 Additions for 2014 modifications to
	   informal confirmation screen. */
	/* Modified final confirmation screen */
	MSG_PRESS_UNDO_TO_RETURN = 18,
	MSG_PRESS_SELECT_TO_HIDE_INFORMAL = 19,
	/* New confirmation screen, stage 1 */
	MSG_CAST_BLANK_VOTE = 20,
	MSG_OPTIONS_INFORMAL_STAGE_1 = 21,
	/* New confirmation screen, stage 2 */
	MSG_OPTIONS_INFORMAL_STAGE_2 = 22,
	MSG_MAX = 23
};
